      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-5 py-20 md:py-28 text-center fade-in-up">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-3">
            ...
            <span className="block gradient-text-green mt-2" style={{ backgroundImage: `linear-gradient(135deg, ${settings.accent_color} 0%, ${primary} 100%)`, WebkitBackgroundClip: 'text', backgroundClip: 'text', WebkitTextFillColor: 'transparent', color: 'transparent' }}>{settings.site_name}</span>
          </h1>
